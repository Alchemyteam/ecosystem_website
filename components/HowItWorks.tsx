    ...
    <section id="how" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 md:text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg text-slate-600">A structured approach to penetrating the formwork sector, ensuring sustainable growth and adoption.</p>
        </div>
          ...
          {PHASES.map((phase) => (
            <div key={phase.phase} className="relative pt-4">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 h-full flex flex-col">
                <div className="mb-4">
                  <span className="inline-block px-3 py-1 bg-slate-100 text-slate-600 text-xs font-bold uppercase rounded-full mb-2">{phase.phase}</span>
